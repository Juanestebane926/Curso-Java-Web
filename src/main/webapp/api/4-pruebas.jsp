...
<div class="contenedor">
        ...
        <div class="herramienta-prueba">
            <div class="campos-prueba">
                <label class="campo-prueba">URL base
                    <input id="apiUrl" type="text" value="http://localhost:8080/demo-web-1.0-SNAPSHOT/api/estudiantes" />
                </label>
    ...
    <section class="seccion">
        ...
        <div class="codigo">
            <pre>fetch('http://localhost:8080/demo-web-1.0-SNAPSHOT/api/estudiantes')
  .then(r => r.json())
  .then(console.log);

fetch('http://localhost:8080/demo-web-1.0-SNAPSHOT/api/estudiantes', {
  method: 'POST',
